...
var chat_id;
var bot = new TeleBot('380563880:AAFvTH1h8sk5SxmCFsZkYcsvhHi4-bvreAY');
  ...
  return function (s) {
    ...
    if (so.mode == 'live')
    {
      bot.on('/start', function(msg){
        chat_id = msg.chat.id;
        msg.reply.text('Started trading for you, take a seat and relax! (chat_id:' + chat_id + ' )' )
      });
      chat_id = 137554585;
      bot.start();
    }
